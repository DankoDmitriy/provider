...
import static com.danko.provider.controller.command.ParamName.TARIFF_ADD_PERIOD;
import static com.danko.provider.controller.command.ParamName.TARIFF_ADD_PRICE;
import static com.danko.provider.controller.command.ParamName.TARIFF_ADD_STATUS;
import static com.danko.provider.controller.command.ParamName.TARIFF_ADD_TRAFFIC;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_ID;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_MAX_SPEED;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_MIN_SPEED;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_NAME;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_ORIGIN;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_PERIOD;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_PRICE;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_STATUS;
import static com.danko.provider.controller.command.ParamName.TARIFF_EDIT_TRAFFIC;
import static com.danko.provider.controller.command.RequestAttribute.ADMIN_TARIFFS_LIST_RESULT_WORK_FOR_MESSAGE;
import static com.danko.provider.controller.command.RequestAttribute.ADMIN_TARIFF_EDIT;
import static com.danko.provider.controller.command.RequestAttribute.ADMIN_TARIFF_EDIT_ORIGINAL;
import static com.danko.provider.controller.command.RequestAttribute.ADMIN_TARIFF_STATUS_LIST;
import static com.danko.provider.controller.command.RequestAttribute.ADMIN_TARIFF_STATUS_LIST_FOR_NEW_TARIFF;
import static com.danko.provider.controller.command.RequestAttribute.ADMIN_TARIFF_WRITE_OFF_LIST;
